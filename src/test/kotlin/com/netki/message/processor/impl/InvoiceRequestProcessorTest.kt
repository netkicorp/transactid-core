...
import com.netki.exceptions.ExceptionInformation.ADDRESS_INFORMATION_INTERNAL_ERROR_PROVIDER
...
import com.netki.exceptions.ExceptionInformation.ENCRYPTION_MISSING_RECIPIENT_KEYS_ERROR
import com.netki.exceptions.ExceptionInformation.ENCRYPTION_MISSING_SENDER_KEYS_ERROR
...
import com.netki.message.extensions.getSerializedMessage
import com.netki.message.extensions.toAttestationType
...
internal class InvoiceRequestProcessorTest {
    ...
    fun `Create and validate InvoiceRequestBinary, Originator and Sender with PkiData and invalid Originator signature`() {
        ...
        assert(exception.message == SIGNATURE_VALIDATION_INVALID_ORIGINATOR_SIGNATURE.format(TestData.Attestations.INVALID_ATTESTATION.name))
    }
    ...
    fun `Create and validate InvoiceRequestBinary, with invalid EV cert`() {
        ...
        assert(exception.message == CERTIFICATE_VALIDATION_EV_NOT_VALID)
    }
}
