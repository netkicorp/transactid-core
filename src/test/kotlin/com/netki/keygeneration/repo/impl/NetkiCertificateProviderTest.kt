...
internal class NetkiCertificateProviderTest {
    private lateinit var netkiKeyProvider: NetkiKeyProvider
    ...
    fun `Create transactionId successfully for a list of attestations`() {
        ...
        netkiKeyProvider = NetkiKeyProvider(client, key)

        val transactionId = netkiKeyProvider.requestTransactionId(ATTESTATIONS_REQUESTED)
    ...
    fun `Retrieve transactionId with a bad request`() {
        ...
        val exception = assertThrows(CertificateProviderException::class.java) {
            netkiKeyProvider.requestTransactionId(ATTESTATIONS_REQUESTED)
        }
    ...
    fun `Submit CSRs related to a transactionId successfully`() {
        ...
        netkiKeyProvider.submitCsrsAttestations(TRANSACTION_ID, CSRS_ATTESTATIONS)
    }
    ...
    fun `Fetch certificates for a transactionId successfully`() {
        ...
        val certificatesAttestations = netkiKeyProvider.getCertificates(TRANSACTION_ID)
    ...
    fun `Fetch certificates for a transactionId with a bad request`() {
        ...
        val exception = assertThrows(CertificateProviderException::class.java) {
            netkiKeyProvider.getCertificates(TRANSACTION_ID)
        }
