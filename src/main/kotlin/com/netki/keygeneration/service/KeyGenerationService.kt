...
internal interface KeyGenerationService {
     ...
     *
     * @param attestationCertificate list of attestations with their corresponding data to generate certificates.
    ...
    fun generateCertificates(attestationCertificate: List<AttestationCertificate>): List<AttestationCertificate>
}
