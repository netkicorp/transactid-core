...
internal class AttestationExtensionTest {
    ...
    fun `Test Attestation Object conversion to Message Object`() {
        ...
        assertEquals(
            Attestation.LEGAL_PERSON_PHONETIC_NAME_IDENTIFIER.toAttestationType(),
            Messages.AttestationType.LEGAL_PERSON_PHONETIC_NAME_IDENTIFIER
        )
        assertEquals(Attestation.ADDRESS_DEPARTMENT.toAttestationType(), Messages.AttestationType.ADDRESS_DEPARTMENT)
        assertEquals(
            Attestation.ADDRESS_SUB_DEPARTMENT.toAttestationType(),
            Messages.AttestationType.ADDRESS_SUB_DEPARTMENT
        )
        assertEquals(Attestation.ADDRESS_STREET_NAME.toAttestationType(), Messages.AttestationType.ADDRESS_STREET_NAME)
        assertEquals(
            Attestation.ADDRESS_BUILDING_NUMBER.toAttestationType(),
            Messages.AttestationType.ADDRESS_BUILDING_NUMBER
        )
        assertEquals(
            Attestation.ADDRESS_BUILDING_NAME.toAttestationType(),
            Messages.AttestationType.ADDRESS_BUILDING_NAME
        )
        ...
        assertEquals(
            Attestation.ADDRESS_TOWN_LOCATION_NAME.toAttestationType(),
            Messages.AttestationType.ADDRESS_TOWN_LOCATION_NAME
        )
        assertEquals(
            Attestation.ADDRESS_DISTRICT_NAME.toAttestationType(),
            Messages.AttestationType.ADDRESS_DISTRICT_NAME
        )
        assertEquals(
            Attestation.ADDRESS_COUNTRY_SUB_DIVISION.toAttestationType(),
            Messages.AttestationType.ADDRESS_COUNTRY_SUB_DIVISION
        )
        assertEquals(
            Attestation.ADDRESS_ADDRESS_LINE.toAttestationType(),
            Messages.AttestationType.ADDRESS_ADDRESS_LINE
        )
        assertEquals(Attestation.ADDRESS_COUNTRY.toAttestationType(), Messages.AttestationType.ADDRESS_COUNTRY)
        assertEquals(
            Attestation.NATURAL_PERSON_PRIMARY_IDENTIFIER.toAttestationType(),
            Messages.AttestationType.NATURAL_PERSON_PRIMARY_IDENTIFIER
        )
        assertEquals(
            Attestation.NATURAL_PERSON_SECONDARY_IDENTIFIER.toAttestationType(),
            Messages.AttestationType.NATURAL_PERSON_SECONDARY_IDENTIFIER
        )
        assertEquals(
            Attestation.NATURAL_PERSON_PHONETIC_NAME_IDENTIFIER.toAttestationType(),
            Messages.AttestationType.NATURAL_PERSON_PHONETIC_NAME_IDENTIFIER
        )
        ...
        assertEquals(
            Attestation.COUNTRY_OF_RESIDENCE.toAttestationType(),
            Messages.AttestationType.COUNTRY_OF_RESIDENCE
        )
        assertEquals(Attestation.COUNTRY_OF_ISSUE.toAttestationType(), Messages.AttestationType.COUNTRY_OF_ISSUE)
        assertEquals(
            Attestation.COUNTRY_OF_REGISTRATION.toAttestationType(),
            Messages.AttestationType.COUNTRY_OF_REGISTRATION
        )
        ...
        assertEquals(
            Attestation.CUSTOMER_IDENTIFICATION.toAttestationType(),
            Messages.AttestationType.CUSTOMER_IDENTIFICATION
        )
        assertEquals(
            Attestation.REGISTRATION_AUTHORITY.toAttestationType(),
            Messages.AttestationType.REGISTRATION_AUTHORITY
        )
    }
    ...
    fun `Test Message conversion to Attestation Object`() {
        ...
        assertEquals(
            Messages.AttestationType.LEGAL_PERSON_PHONETIC_NAME_IDENTIFIER.toAttestation(),
        ...
        assertEquals(
            Messages.AttestationType.ADDRESS_SUB_DEPARTMENT.toAttestation(),
        ...
        assertEquals(
            Messages.AttestationType.ADDRESS_BUILDING_NUMBER.toAttestation(),
        ...
        assertEquals(
            Messages.AttestationType.ADDRESS_TOWN_LOCATION_NAME.toAttestation(),
        ...
        assertEquals(
            Messages.AttestationType.ADDRESS_COUNTRY_SUB_DIVISION.toAttestation(),
        ...
        assertEquals(
            Messages.AttestationType.NATURAL_PERSON_PRIMARY_IDENTIFIER.toAttestation(),
            Attestation.NATURAL_PERSON_PRIMARY_IDENTIFIER
        )
        assertEquals(
            Messages.AttestationType.NATURAL_PERSON_SECONDARY_IDENTIFIER.toAttestation(),
            Attestation.NATURAL_PERSON_SECONDARY_IDENTIFIER
        )
        assertEquals(
            Messages.AttestationType.NATURAL_PERSON_PHONETIC_NAME_IDENTIFIER.toAttestation(),
            Attestation.NATURAL_PERSON_PHONETIC_NAME_IDENTIFIER
        )
        ...
        assertEquals(
            Messages.AttestationType.COUNTRY_OF_REGISTRATION.toAttestation(),
        ...
        assertEquals(
            Messages.AttestationType.CUSTOMER_IDENTIFICATION.toAttestation(),
            Attestation.CUSTOMER_IDENTIFICATION
        )
        assertEquals(
            Messages.AttestationType.REGISTRATION_AUTHORITY.toAttestation(),
